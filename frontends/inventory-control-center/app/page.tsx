...
// (NEXT_PUBLIC_FEATURE_INVENTORY_ENABLED) so the frontend and its backend module enable/disable together.
...
export default function Page() {
  ...
  return (
    <main style={{ fontFamily: "system-ui", padding: "3rem", maxWidth: 640 }}>
      <h1>Inventory Control Center</h1>
      <p>Browse stock levels, perform adjustments, and view valuation.</p>
      <p>
        <strong>User:</strong> Inventory managers, buyers, and the finance team
      </p>
      <p>
        Backend: <code>http://localhost:3003</code> —{" "}
